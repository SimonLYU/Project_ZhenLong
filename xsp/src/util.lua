...
function util.clickRightSpace()
	width,height = getScreenSize()
	util.click(10,width * 0.5)
	mSleep(500)
end
...
function util.initMyHud()
	screen_width,screen_height = getScreenSize()
	my_hud_id = createHUD() 
	showHUD(my_hud_id,"主人,欢迎您回来,准备好了我们就开始吧~",hud_text_font_size,hud_text_color,hud_background_color,0,0,screen_width  * 0.15,screen_width * 0.7,screen_height  * 0.055)  
end
